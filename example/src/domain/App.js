import { useIsIntersecting, useWasIntersecting, useIsIntersectingFixedElement, visualizeRootMargin }  from '@kaliber/use-is-intersecting'
...
export default function App() {
  ...
  return (
    <div className={styles.app}>
      <input className={styles.rootMarginInput} value={rootMargin} onChange={e => setRootMargin(e.target.value)} />
